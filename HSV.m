...
%fc_img_test=mvgd1(test_face_matrix,mean_face,covar_face3,fc_test_image_num,3600);
%fc_img_test_1=mvgd1(test_face_matrix,mean_bg,covar_bg3,fc_test_image_num,3600);
...
%bg_img_test=mvgd1(test_background_matrix,mean_bg,covar_bg3,bg_test_image_num,3600);
%bg_img_test_1=mvgd1(test_background_matrix,mean_face,covar_face3,bg_test_image_num,3600);
...
path=[directory '\hsv_model_data.mat'];
save(path);