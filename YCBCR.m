...
%fc_img_test=mvgd1(test_face_matrix,mean_face,covar_face2,fc_test_image_num);
%fc_img_test_1=mvgd1(test_face_matrix,mean_bg,covar_bg2,fc_test_image_num);
...
%fc_img_test=mvnpdf(transpose(background_matrix),transpose(mean_face),covar_face2);
 ...
 %bg_img_test=mvgd1(test_background_matrix,mean_bg,covar_bg2,bg_test_image_num);
 %bg_img_test_1=mvgd1(test_background_matrix,mean_face,covar_face2,bg_test_image_num);
...
path=[directory '\ycbcr_model_data.mat'];
save(path);